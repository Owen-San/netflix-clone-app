    ...
    <div className="mt-6 grid grid-cols-1 gap-x-4 border px-4 md:grid-cols-4 md:border-x-0 md:border-t md:border-b-0 md:px-0">
      <div className="space-y-2 py-4">
        ...
        <button
          ...
          className="h-10 w-3/5 whitespace-nowrap bg-gray-300 py-2 text-sm font-medium text-black shadow-md hover:bg-gray-200 md:w-4/5 disabled:opacity-60"
      ...
      <div className="col-span-3">
        ...
        <div className="flex flex-col justify-between pt-4 md:flex-row md:items-start">
          <p className="order-2 mt-4 text-sm text-gray-300 font-semibold md:order-1 md:mt-0">
